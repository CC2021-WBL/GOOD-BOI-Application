const results = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { codeName: '0.2', result: 8.5 },
      { codeName: '0.3', result: 8 },
      { codeName: '0.4', result: 8 },
      { codeName: '0.5', result: 8 },
      { codeName: '0.6', result: 9 },
      { codeName: '0.7', result: 7 },
      { codeName: '0.8', result: 8.5 },
    ],
  },
  {
